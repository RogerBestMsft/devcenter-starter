...
module peerHub2Spoke 'networkPeering.bicep' = [for i in range(0, length(SpokeNetworkIds)): {
...
module peerSpoke2Hub 'networkPeering.bicep' = [for i in range(0, length(SpokeNetworkIds)): {
